let proximoId = 1; // Variable para llevar el control del próximo ID
...
document.addEventListener('DOMContentLoaded', function () {
  ...
  reservarBtn.addEventListener('click', function () {
    ...
    const nuevoTurno = {
      id: proximoId, // Asigna el próximo ID
      cliente: cliente,
      telefono: telefono,
      email: mail,
      sintomas: sintomas,
    ...
    // Incrementa el próximo ID para la próxima reserva
    proximoId++;
